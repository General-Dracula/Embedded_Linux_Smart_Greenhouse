/*
 * I2CDevice.cpp  Created on: 24 April 2016
 * by Erland Larsen, VIA University College
 * for the purpose of the course EOS I1.
 *
 * Adapted to from the original:
 ...
 * @param number the number of registers to read from the device
 * @return a pointer of type unsigned char* that points to the first element in the block of bytes
 */
